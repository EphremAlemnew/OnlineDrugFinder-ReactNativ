...
import AdminPharmaDetailScreen from "../screens/AdminPharmaDetailScreen";
...
import SysAdminSettings from "../screens/SysAdminSettings";
import HomeFree from "../screens/HomeFree";
import FreeDrugDetails from "../screens/FreeDrugDetails";
import FreeDrugList from "../screens/FreeDrugList";
import FreePharmacyDetails from "../screens/FreePharmacyDetails";
...
import LoggedDrugDetails from "../screens/LoggedDrugDetails";
import LoggedDrugList from "../screens/LoggedDrugList";
import LoggedPharmacyList from "../screens/LoggedPharmacyList";
import LoggedPharmacyDetails from "../screens/LoggedPharmacyDetails";
import LoggedPrescriptionList from "../screens/LoggedPrescriptionList";
import LoggedPrescriptionDetails from "../screens/LoggedPrescriptionDetails";
import LoggedSendPrescription from "../screens/LoggedSendPrescription";
  ...
  return (
    ...
    <View style={{height:Layout.height*72/100,}}>
      ...
      >
        ...
        <Text style={{color:Colors.primary,fontFamily:Font["poppins-bold"], fontSize:FontSize.large}}>Register pharmacy</Text>
      </TouchableOpacity>
      <TouchableOpacity
      style={{flexDirection:'row', height:Layout.height*5/100,}}
      ...
      ><Ionicons name="mail-outline" color={Colors.primary} style={{marginRight:20,marginLeft:20}}  size={Spacing*3}/>
        ...
        <Text style={{color:Colors.primary,fontFamily:Font["poppins-bold"], fontSize:FontSize.large}}>Send us Comment</Text>
      </TouchableOpacity>
      <TouchableOpacity
      style={{flexDirection:'row', height:Layout.height*5/100,}}
...
function RootNavigator() {
  return (
    ...
    >
      ...
      <Stack.Screen name="AdminPharmaDetails" component={AdminPharmaDetailScreen} />
      <Stack.Screen name="AddPharmacy" component={AddPharmacyScreen} />
      <Stack.Screen name="DrugList" component={DrugListScreen} />
      <Stack.Screen name="AddDrugs" component={AddDrugScreen} />
      ...
      <Stack.Screen name="SysAdminSettings" component={SysAdminSettings} />
      <Stack.Screen name="HomeFree" component={HomeFree} />
      <Stack.Screen name="FreeDrugDetails" component={FreeDrugDetails} />
      <Stack.Screen name="FreeDrugList" component={FreeDrugList} />
      <Stack.Screen name="FreePharmacyDetails" component={FreePharmacyDetails} />
      ...
      <Stack.Screen name="LoggedDrugDetails" component={LoggedDrugDetails} />
      ...
      <Stack.Screen name="LoggedPharmacyDetails" component={LoggedPharmacyDetails} />
      <Stack.Screen name="LoggedPrescriptionList" component={LoggedPrescriptionList} />
      <Stack.Screen name="LoggedPrescriptionDetails" component={LoggedPrescriptionDetails} />
      <Stack.Screen name="LoggedSendPrescription" component={LoggedSendPrescription} />
