  ...
  return (
    <SafeAreaView>
      ...
      <View style={{
        ...
        {phaRequest.map((req)=>{return(

            <View key={req.id} style={{ borderRadius:5, borderColor:Colors.primary}}>
          <TouchableOpacity 
          onPress={()=>handleView(req.id,req.name,req.OwnersFname,req.ownersLname,req.document.id,req.document.name,req.document.image,req.location.id,req.location.latitude,req.location.longitude,req.email,req.licenseNo,req.phoneNo,req.subCity,req.kebele,req.houseNo)} 
          style={{
        height:40,
        margin:Spacing,
        marginTop:5,
      ...
      <TouchableOpacity onPress={()=>navigate('RegisterHome')} style={{alignItems:'center', backgroundColor:Colors.onPrimary,marginLeft:Layout.width*0/100,width:Layout.width*20/100,padding:Spacing}}>
            ...
            <Image style={{tintColor:Colors.onPrimary,width:Layout.width*9/100,height:Layout.width*9/100}} source={require("../assets/images/document.png")}></Image>
              <Text style={{color:Colors.onPrimary}}>Requests</Text>
            </TouchableOpacity>
