...
import LoggedPrescriptionDetails from "./LoggedPrescriptionDetails";
...
const LoggedPrescriptionList = ({ navigation: { navigate } }) => {
  ...
  const handleView2=(pId,sName2,dName,preImage2,uId)=>{
    setP_ID(pId)
    setDrugName(dName)
        ...
        >
          ...
          <View style={{ marginVertical: Spacing * 2 }}>
            {prescriptions2.length>0?prescriptions2.map((pre2)=>{return(
              ...
              onPress={()=>handleView2(pre2.id,pre2.senderName,pre2.drugName,pre2.prescriptionImage)}
            ...
            {/* <TouchableOpacity
              ...
              style={Layout.styles.ListTouch}
            >
              <Text style={Layout.styles.ListTouchText}>Prescription 1</Text>
            </TouchableOpacity> */}
            <Text
              style={{
                fontSize: FontSize.large,
           ...
           {prescriptions.length>0?prescriptions.map((pre)=>{return(
              ...
              style={{alignItems:"center",backgroundColor:Colors.primary,marginBottom: Layout.height*2/100,paddingBottom:5}}
            >
              <Text style={Layout.styles.ListTouchText}>{pre.senderName}</Text> 
              <Image  source={ {uri: pre.prescriptionImage }} style={{ width: Layout.width*90/100, height: Layout.height*30/100 }} />
            </TouchableOpacity>
            )}):<View><View style={{alignItems:"center"}}><Text style={{marginLeft:5,
              fontFamily:Font['poppins-semiBold'],
              fontSize:FontSize.large,
            ...
            {/* <TouchableOpacity
              ...
              style={Layout.styles.ListTouch}
            >
              <Text style={Layout.styles.ListTouchText}>Prescrition</Text>
            </TouchableOpacity> */}
            ...
            <TouchableOpacity onPress={toggleFloatScreen2} style={{position: "absolute",
      ...
      {isVisible && (
        ...
        >
          ...
          >
            ...
            >
              Don't take drugs unless your doctor told you to do so!
            </Text>
      ...
      <View  style={{flexDirection:'row',alignItems:'flex-end', }}>
          <TouchableOpacity onPress={()=>navigate('LoggedHome')} style={{alignItems:'center', marginLeft:Layout.width*0/100,width:Layout.width*20/100,padding:Spacing}}>
            ...
            <Image style={{tintColor:Colors.primary,width:Layout.width*9/100,height:Layout.width*9/100}} source={require("../assets/images/drugstore.png")}></Image>
              <Text style={{color:Colors.primary}}>Pharmacy</Text>
            </TouchableOpacity>
            ...
            <Image style={{tintColor:Colors.primary,width:Layout.width*9/100,height:Layout.width*9/100}} source={require("../assets/images/drugs.png")}></Image>
              <Text style={{color:Colors.primary}}>Drugs</Text>
            </TouchableOpacity>
            ...
            <Ionicons name="document-text-outline" color={Colors.onPrimary} size={Spacing*3}/>
              <Text style={{color:Colors.onPrimary}}>Prescription</Text>
            </TouchableOpacity>
          </View>
    </SafeAreaView>
  );
