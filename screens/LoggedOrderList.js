      ...
      <View style={{flexDirection:'row'}}>
         ...
         <ScrollView style={{height:Layout.height*83/100,backgroundColor:Colors.lightPrimary,}}  scrollEnabled={true}>
          {orders.length>0?orders.map((o)=>{return(
            <TouchableOpacity key={o.id} onPress={()=>handleView(o.id,o.quantity,o.total_price,o.payMethod,o.prescriptionImage,o.pharmacy['id'],o.drug['id'],o.address['id'],o.user['id'],o.validPrescription,o.assignedDeliverer)}>
